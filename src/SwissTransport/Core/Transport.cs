namespace SwissTransport.Core
{
    ...
    public class Transport : ITransport, IDisposable
    {
        ...
        public async Task<Connections> GetConnectionsAsync(string fromStation, string toStation, string departuredate, string departuretime)
        {
            if (string.IsNullOrEmpty(fromStation))
            {
                throw new ArgumentNullException(nameof(fromStation));
        ...
        public Connections GetConnections(string fromStation, string toStation, string departuredate, string departuretime) =>
            this.GetConnectionsAsync(fromStation, toStation, departuredate, departuretime)
                .ConfigureAwait(false)
                .GetAwaiter()
                .GetResult();
